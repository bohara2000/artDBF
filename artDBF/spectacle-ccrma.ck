...
adc => Gain master => Spectacle spect => dac;

0.3 => master.gain;

0.3 => spect.mix; // mix half processed and unprocessed signal
spect.range(100,2000); // limit frequency range
30 => spect.bands; // set number of bands to 20
