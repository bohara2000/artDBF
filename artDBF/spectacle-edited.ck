...
public class spectacle-class
{
	//adc => Gain m => Spectacle spect => dac;
	Gain m;
	Spectacle spect;
	m => spect;
	0.6 => m.gain;
	0.8 => spect.mix; // mix half processed and unprocessed signal
	spect.range(100,4100); // limit frequency range
	20 => spect.bands; // set number of bands to 20
	//10::second => spect.delay;
	0.1 => spect.feedback;
	...
	fun void DisconnectAndRingDown()
	{		
